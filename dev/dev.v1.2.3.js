...
var iv = (Fi, et, nr) =>
  et in Fi
    ? tv(Fi, et, { enumerable: !0, configurable: !0, writable: !0, value: nr })
    : (Fi[et] = nr);
var q = (Fi, et, nr) => iv(Fi, typeof et != "symbol" ? et + "" : et, nr);
(function () {
  "use strict";
...
/*$vite$:1*/`),
   ...
   */ var W,
    ...
    Ou = function () {
      return W || (Lu() && (W = window.gsap) && W.registerPlugin && W);
    },
    gr = function (e) {
      return !!~Ko.indexOf(e);
    },
    ...
    Z = (function () {
      function r(t, i) {
        Xr || r.register(W), ea(this), this.init(t, i);
      }
      var e = r.prototype;
      return (
        (e.init = function (i, n) {
          ...
          if (
            ...
            g &&
              ...
              "scrollBehavior" in he.style &&
                W.set(b ? [he, Xt] : A, { scrollBehavior: "auto" }),
              oe.forEach(function ($) {
                return (
                  dt($) &&
              ...
              (Bt = W.delayedCall(g.delay || Fe / 2 || 0.1, function () {
                var $ = de(),
                  ee = ct() - ie < 500,
                  K = be.tween;
                if (
                  ...
                  var te = ($ - se) / fe,
                    ...
                    Re = W.utils.clamp(-te, 1 - te, (Ur(ce / 2) * ce) / 0.185),
            ...
            (He = this.markerStart = Is("start", l, Or, M, zt, Qt, 0, P)),
              ...
              P && (mi = W.quickSetter([He, We], M.a, Ve)),
              !y &&
                !(bi.length && Ki(A, "fixedMarkers") === !0) &&
                (Hf(b ? he : A),
                W.set([N, Ke], { force3D: !0 }),
                (dn = W.quickSetter(N, M.a, Ve)),
                (H = W.quickSetter(Ke, M.a, Ve)));
          }
          if (P) {
            ...
            (C.refresh = function ($, ee, K, te) {
              if (!((ut || !C.enabled) && !ee)) {
                ...
                for (
                  D &&
                  vr(K) &&
                  ((rs = W.getProperty(N, M.p)), (no = W.getProperty(Ke, M.p)));
                  nt-- > 0;
                ...
                is &&
                  ...
                  U && U.invalidate(),
                  isNaN(rs) ||
                    ((rs -= W.getProperty(N, M.p)),
                    (no -= W.getProperty(Ke, M.p)),
                    qs(N, M, rs),
                    qs(He, M, rs - (te || 0)),
                    qs(Ke, M, no),
                    qs(We, M, no - (te || 0))),
        ...
        (r.enable = function () {
          if (
            ...
            W &&
              ((On = W.utils.toArray),
              (Mn = W.utils.clamp),
              (ea = W.core.context || Si),
              (Qo = W.core.suppressOverwrites || Si),
    ...
    sp = () => {
      document.querySelectorAll('[data-tabs="wrapper"]').forEach((e) => {
        ...
        function d(h) {
          ...
          p &&
            (G.set(p, { scaleX: 0, transformOrigin: "left center" }),
            (c = G.to(p, {
              scaleX: 1,
              duration: s / 1e3,
              ease: "power1.inOut",
      ...
      const c = (h, p, v, _) => {
        ...
        f = (h, p, v, _) => {
          G.to(v, { duration: 0.5, ease: "expo.out", rotateX: 0, color: a }),
            G.to(p, { autoAlpha: 0, duration: 0.3, ease: "expo.out" }),
            G.to(_, {
              autoAlpha: 0,
              duration: 0.01,
              ease: "expo.out",
            ...
            e.forEach(
              ({
                ...
                u.classList.remove("is--open"),
                  ...
                  G.to(h, { scaleX: 0, duration: 0.7, ease: "power3.out" }),
      ...
      document
        ...
        .forEach((s, o) => {
            ...
            onUpdate: (x) => {
              if (
                ...
                (P = G.utils.clamp(-60, 60, P)),
                  G.timeline({ onUpdate: () => w.timeScale(E.value) }).fromTo(
                    E,
                    { value: P },
          ...
          function S(x) {
            _ = x;
            let P = { value: 1 },
              O = G.timeline({ onUpdate: () => w.timeScale(P.value) });
            x
